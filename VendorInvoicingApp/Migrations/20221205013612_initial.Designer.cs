...
namespace BoaImAssignment3.Migrations
{
    ...
    [Migration("20221205013612_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoaIm_Assignment3.Entities.Invoice", b =>
                {
            ...
            modelBuilder.Entity("BoaIm_Assignment3.Entities.InvoiceLineItem", b =>
                {
            ...
            modelBuilder.Entity("BoaIm_Assignment3.Entities.PaymentTerms", b =>
                {
                    b.Property<int>("PaymentTermsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoaIm_Assignment3.Entities.Vendor", b =>
                {
                    b.Property<int>("VendorId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BoaIm_Assignment3.Entities.Invoice", b =>
                {
                    b.HasOne("BoaIm_Assignment3.Entities.PaymentTerms", "PaymentTerms")
                        .WithMany("Invoices")
                        .HasForeignKey("PaymentTermsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BoaIm_Assignment3.Entities.Vendor", "Vendor")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("BoaIm_Assignment3.Entities.InvoiceLineItem", b =>
                {
                    b.HasOne("BoaIm_Assignment3.Entities.Invoice", "Invoice")
